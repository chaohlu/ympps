...
<%
Response.Write "<h4 style='margin: 4em 0 1em;'><hr />All web pages created by user " & Session("NetID") & "</h4>" & chr(10)
Response.Write "<table id='allpages'><tbody>" & chr(10)
...
While NOT objRS.EOF
	...
	Response.Write "<tr><td>" & objRS("Title") & "</td><td>" & objRS("URL") & "</td><td>Created " & FormatDateTime(objRS("Created"),2) & "</td><td><a href='makepage_fixlinks.asp?action=update&subfolder=" & objRS("Subfolder") & "'>UPDATE LINKS</a></td><td><a href='" & objRS("URL") & "' target='_blank'>PREVIEW</a></td></tr>" & chr(10)

objRS.MoveNext
Wend

Response.Write "</tbody></table>" & chr(10)
